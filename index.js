...
function initPlayer() {
  const tracks = [
    ...
    {src: 'assets/SpoMp3 ETA NewJeans.mp3', label: 'ETA', cover: 're/super shy.png', bg: 'linear-gradient(180deg, ##8bd7f0 0%, #effbff 100%)'},
    ...
    {src: 'assets/how sweet.mp3', label: 'How Sweet', cover: 're/how sweet.png', bg: 'linear-gradient(180deg, #ffe0f0 0%, #fff5fa 100%)'},
